package com.mnikiforov.steelcheckbox;
...
public class SteelCheckBoxUI extends javax.swing.plaf.basic.BasicCheckBoxUI implements java.beans.PropertyChangeListener, java.awt.event.ComponentListener, java.awt.event.MouseListener {
    ...
    private void init() {
	foreground = new java.awt.geom.RoundRectangle2D.Double(pos.x + 1/* + backgroundImage.getWidth() * 0.03846153989434242*/,
		pos.y + 1/* + backgroundImage.getHeight() * 0.0714285746216774*/, backgroundImage.getWidth() * 0.923076868057251, backgroundImage.getHeight() * 0.8571428060531616, backgroundImage.getHeight() * 0.8571428571, backgroundImage.getHeight() * 0.8571428571);
	...
	final ConicalGradientPaint KNOB_GRADIENT = new ConicalGradientPaint(true, KNOB_CENTER, 0f, KNOB_FRACTIONS, KNOB_COLORS);
